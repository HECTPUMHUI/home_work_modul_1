...
# # task 3 ver.01
# list_for_3 = [32, 43, 1, 3, 4, 5, 34, 5, 1, 7, 10, 34, 17, 11, 4, 3, 2, 6, 14, 1412424, 232, 223,32,1,1,2]
# num = []
# num2 = []
...
#         num2.extend(num)
# print(num2)
# завдання 3, в процесі розробки, працює сортування за
# спаданням кожних 5-ти елементів списку будь-якої довжини